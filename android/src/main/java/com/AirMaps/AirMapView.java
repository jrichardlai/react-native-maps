    ...
    public void setLoadingIndicatorColor(Integer loadingIndicatorColor) {
        ...
        if (this.mapLoadingProgressBar != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ColorStateList progressTintList = ColorStateList.valueOf(Color.TRANSPARENT);;
                ColorStateList secondaryProgressTintList = ColorStateList.valueOf(Color.TRANSPARENT);
                ColorStateList indeterminateTintList = ColorStateList.valueOf(Color.TRANSPARENT);
